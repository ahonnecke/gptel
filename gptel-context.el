...
;; New helper function for direct calls, makes it work
(defun gptel-context-remove-all-direct ()
  "Directly remove all gptel context."
  (interactive)
  (gptel-context-remove-all))

(define-key gptel-mode-map (kbd "C-c C-c") #'gptel-context-remove-all-direct)
