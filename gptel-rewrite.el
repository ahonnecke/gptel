...
(defun gptel--remove-all-context ()
  "Remove all context overlays and reset any associated variables."
  (interactive)
  (dolist (ov gptel--rewrite-overlays)
    (delete-overlay ov))
  (setq gptel--rewrite-overlays nil)
  (message "All context removed."))
